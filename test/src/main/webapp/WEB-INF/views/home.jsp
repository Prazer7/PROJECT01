			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="${pageContext.request.contextPath}/home.jsp" id="logo"> 니콘 내콘 </a></h1>
								<hr />
								<p>당신이 편리한 소비를 위하여</p>
							</header>
							<footer>
								<a href="#banner" class="button circled scrolly">sharing</a>
								<br>
								<br>
								<a href="#banner" class="button circled scrolly">get</a>
							</footer>
						</div>
				...
				<section id="banner">
					<header>
						<h2>당신이 필요한 기프티콘<strong>sharing gift</strong>.</h2>
					</header>
				</section>
				...
				<section class="carousel">
					...
					<div class="reel">
						...
						<article>
							...
							<header>
								<h3><a href="#"> 벨벳 다크 모카 나이트로 </a></h3>
							</header>
							<p> 김유섭 회원님 : 2022년 08월 08일 _2025년 08월 26일 </p>
						</article>

						<article>
							<a href="#" class="image featured"><img src="${pageContext.request.contextPath}/resources/images/pic04.jpg" alt="" /></a>
							<header>
								<h3><a href="#"> 제주 비자림 콜드 브루 </a></h3>
							</header>
							<p> 김유섭 회원님 : 2022년 08월 08일 _2025년 08월 26일 </p>
						</article>
						...
						<article>
							...
							<header>
								<h3><a href="#"> 사케라또 비안코 오버 아이스 </a></h3>
							</header>
							<p> 김유섭 회원님 : 2022년 08월 08일 _2025년 08월 26일 </p>
						</article>
			...
			<!-- Main -->
				<div class="wrapper">
					...
					<article id="main" class="container special">
						<a href="#" class="image featured"><img src="${pageContext.request.contextPath}/resources/images/" alt="" /></a>
						<header>
							<h2><a href="#"> 서비스 소개 </a>
							</h2>
						</header>
							...
							<!-- Photos -->
								<section class="col-4 col-12-mobile">
									...
									<div class="row gtr-25">
										...
										<div class="col-6">
											<a href="#" class="image fit"><img src="${pageContext.request.contextPath}/resources/images/pic13.jpg" alt="" /></a>
										</div>
										<div class="col-6">
											<a href="#" class="image fit"><img src="${pageContext.request.contextPath}/resources/images/pic14.jpg" alt="" /></a>
										</div>
										<div class="col-6">
											<a href="#" class="image fit"><img src="${pageContext.request.contextPath}/resources/images/pic15.jpg" alt="" /></a>
										</div>
									</div>
								</section>
